...
- [ ] No server-side password strength validation visible — weak passwords may be accepted (P2)
...
- [ ] Create-user wizard only offers "Person" user type — Thunder claims to support customers, employees, businesses, AI agents but none are available (P2)
